    ...
    <main class="main" id="top">
      <div class="container-fluid px-0">
        ...
        <div class="content container">
                ...
                <div class="card-header p-4 border-bottom border-300 bg-soft">
                  <div class="row g-3 justify-content-between align-items-center">
                    <div class="col-12 col-md">
                        <h4 class="text-900 mb-0" data-anchor="data-anchor">Decision tree for raw materials</h4>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-header bg-100 pt-3 pb-2 border-bottom-0">
                    <ul class="nav justify-content-between nav-wizard">
                        ...
                        <li class="nav-item"><a class="nav-link fw-semi-bold disabled" href="#bootstrap-wizard-tab3" data-bs-toggle="tab" data-wizard-step="3">
                            <div class="text-center d-inline-block"><span class="d-none d-md-block fs--1">Step3</span><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-3"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Intended<br>use</span></div>
                            </a></li>
                        <li class="nav-item"><a class="nav-link fw-semi-bold disabled" href="#bootstrap-wizard-tab4" data-bs-toggle="tab" data-wizard-step="4">
                            <div class="text-center d-inline-block"><span class="d-none d-md-block fs--1">Step4</span><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-4"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Manufacturing<br>process</span></div>
                            </a></li>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" aria-labelledby="bootstrap-wizard-tab1" id="bootstrap-wizard-tab1">
                        <form class="needs-validation" id="wizardForm1" novalidate="novalidate" data-wizard-form="1" required="required">
                            <div class="mb-5">
                            <label for="step1-1">Please input or select the microorganism detected from your materials:</label>
                            ...
                            <div class="mb-2">
                            <label for="step1-2">Does the microorganism damage the properties and efficacy of the materials?</label>
                    ...
                    <form class="needs-validation" id="wizardForm3" novalidate="novalidate" data-wizard-form="3" required="required">
                      <div class="mb-2">
                        <label for="step3">Is it an objectionable microorganism controlled for the intended use of the product?</label>
                    ...
                    <form class="needs-validation" id="wizardForm4" novalidate="novalidate" data-wizard-form="4" required="required">
                      <div class="mb-2">
                        <label for="step4">Can the subsequent manufacturing processes effectively remove its contamination?</label>
                        <select class="form-select" name="flag4" required="required">
                          <option value="">Select one option ...</option>
                          <option value="1">Yes</option>
                          <option value="0">No</option>
                        </select>
          ...
          <div class="row">
            <div class="col-12 col-xxl-10 offset-xxl-1">
              <p>
                <a class="btn btn-phoenix-secondary mt-2" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Decision tree</a>
              </p>
              <div class="collapse show" id="collapseExample">
                <img src="assets/img/RM_DT.png" class="img-fluid" alt="Decision tree for finished product">
              </div>
            </div>
          </div>
        </div>
      ...
      <script>
        ...
        document.querySelector('[data-wizard-next-btn="data-wizard-next-btn"]').addEventListener('click', function(e) {
            ...
            fetch('scripts/raw_materials_DT.php', {
                method: 'POST',
                body: formData,
            })
                    ...
                    if (data.message === 'objectionable') {
                      resultTabContent.innerHTML = `
                        ...
                        <div class="alert alert-outline-warning d-flex align-items-center mt-3" role="alert">
                          ...
                          <h4 class="alert-heading">High risk: This microorganism could potentially be objectionable for your materials.</h4>
                        </div>
                      `;
                      relatedRecall.innerHTML = `
                        <button class="btn btn-phoenix-secondary rounded-pill mt-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTable" aria-expanded="false" aria-controls="collapseTable">
                      ...
                      resultTabContent.innerHTML = `
                        ...
                        <div class="alert alert-outline-success d-flex align-items-center mt-3" role="alert">
                          ...
                          <h4 class="alert-heading">This microorganism can be classified as low risk for your product.</h4>
                        </div>
                      `;
                    }
